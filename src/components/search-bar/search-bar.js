...
class SearchBar extends Component {
    ...
    onSubmit = ()=>{
        fetch(`https://cors-anywhere.herokuapp.com/https://api.deezer.com/search/?q=${this.state.query}&apiKey=${API_KEY}`,{
            method : 'GET'
        })
        .then(response=>{ 
        ...
        if (this.state.result_artist){
            return(
                <div>
                    ...
                    <MusicList info={this.state.result_artist} info_1={this.state.result_album} info_2={this.state.result_track}/>
                </div>
            )
        }
